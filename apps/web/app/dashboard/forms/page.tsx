        ...
        <div className="flex flex-1 flex-col">
            <header className="flex h-14 shrink-0 items-center gap-2 border-b border-[#365314]/40 px-4 lg:px-6">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-base font-semibold text-white">Forms</h1>
                </div>
            </header>

            <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold text-white">All Forms</h2>
                            ...
                            {isLoading ? (
                                ...
                                forms.map((f) => (
                                    <TableRow
                                        ...
                                        onClick={() => router.push(`/dashboard/forms/${f.id}/analytics`)}
                                    >
                            ...
                            <FieldGroup>
                                <Field>
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">
                                        You can add fields, description, and theme on the next page.
                                    </p>
                                </Field>
                            </FieldGroup>
