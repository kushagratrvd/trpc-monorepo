...
export default function SignupPage() {
  return (
    <div 
      ...
      style={{
        backgroundImage: "linear-gradient(to bottom, rgba(15, 23, 42, 0.75), rgba(15, 23, 42, 0.85)), url('/assets/minecraft/backgrounds/Ancient_Hunt.png')",
      }}
    >
      ...
      <div className="w-full max-w-sm relative z-10 bg-[#18181b] border-2 border-[#365314] p-6 rounded-sm shadow-hud-outset">
        <SignupForm />
      </div>
    </div>
  )
